...
class ArbParser : IArbParser {
    ...
    override fun parse(projectBasePath: String, config: AccessibleGenConfig): ArbParseResult? {
    ...
    internal fun findMasterArbFile(arbDir: File, masterLocale: String): File? {
    ...
    internal fun parseArbFile(file: File, readerSuffix: String): ArbParseResult {
        val gson = Gson()
        val mapType = object : TypeToken<Map<String, Any>>() {}.type
